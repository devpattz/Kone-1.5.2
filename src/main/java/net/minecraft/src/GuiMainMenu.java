...
public class GuiMainMenu extends GuiScreen {
	...
	public void initGui() {
		...
		if (EaglerAdapter.isIntegratedServerAvailable()) {
			...
			this.buttonList.add(new GuiButtonPrc(3, this.width / 2 - 100, var4 + 24 * 3, var2.translateKey("menu.githubrepo")));
		...
		this.buttonList.add(new GuiButtonOptions(6, this.width / 2 - 40, var12));
		this.buttonList.add(new GuiButtonProfile(7, this.width / 2 - 15, var12));
		this.buttonList.add(new GuiButtonReadme(8, this.width / 2 - -10, var12));
	...
	private static final TextureLocation prcLogo = new TextureLocation("/title/main_menu/logo.png");
