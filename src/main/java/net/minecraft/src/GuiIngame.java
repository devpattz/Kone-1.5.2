	...
	public void renderGameOverlay(float par1, boolean par2, int par3, int par4) {
		...
		if (this.mc.gameSettings.showDebugInfo) {
			...
			if (mc.gameSettings.keyStrokes){
                ...
                var8.drawStringWithShadow("W",  46, 23, 0xFFFFFF);
                var8.drawStringWithShadow("A", 21, 48, 0xFFFFFF);
                var8.drawStringWithShadow("S",  46, 48, 0xFFFFFF);
                var8.drawStringWithShadow("D", 71, 48, 0xFFFFFF);
                var8.drawStringWithShadow("Left", 20, 72, 0xFFFFFF);
                var8.drawStringWithShadow("Right", 56, 72, 0xFFFFFF);
				/* 
				var8.drawStringWithShadow("LMB", 24, 74, 0xFFFFFF);
				var8.drawStringWithShadow("RMB", 64, 74, 0xFFFFFF);
				*/
                var8.drawStringWithShadow("\u00A7m----", 38, 95, 0xFFFFFF);
                var8.drawStringWithShadow("Sneak", 35, 110, 0xFFFFFF);
				...
				*/
				...
				if (Minecraft.debugFPS < 10) {
					fpsPos = 35;
				}
				else if (Minecraft.debugFPS < 100) {
					fpsPos = 33;
				}
				else {
					fpsPos = 31;
                ...
                var8.drawStringWithShadow(""+Minecraft.debugFPS+" FPS", fpsPos, 130, 0xFFFFFF);
				...
				this.drawGradientRect(17, 17, 113, 42, -1072689136, -804253680);
				EaglerAdapter.glPopMatrix();
                EaglerAdapter.glPushMatrix();
				int fpsPos = 35;
                //int renderFPS = this.mc.renderGlobal.getDebugInfoShort().length();
                ...
                var8.drawStringWithShadow(""+Minecraft.debugFPS+" FPS", fpsPos, 18, 0xFFFFFF);
			}

			if(mc.gameSettings.showCoordinates) {
				EaglerAdapter.glPopMatrix();
                EaglerAdapter.glPushMatrix();
                this.drawGradientRect(var6 - 120, 13, var6 - 13, 65, -1072689136, -804253680);
                var24 = MathHelper.floor_double((double) (this.mc.thePlayer.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3;
                var8.drawStringWithShadow("[X: " + MathHelper.floor_double(this.mc.thePlayer.posX) + "]", var6 - 113, 20, 16777215);
                var8.drawStringWithShadow("[Y: " + MathHelper.floor_double(this.mc.thePlayer.posY) + "]", var6 - 113, 30, 16777215);
                var8.drawStringWithShadow("[Z: " + MathHelper.floor_double(this.mc.thePlayer.posZ) + "]", var6 - 113, 40, 16777215);
				String colorDirections = "";
				if (Direction.directions[var24] == "NORTH"){
					colorDirections = EnumChatFormatting.RED + "North" + EnumChatFormatting.RESET;
				}
				else if (Direction.directions[var24] == "WEST"){
					colorDirections = EnumChatFormatting.YELLOW + "West" + EnumChatFormatting.RESET;
				}
				else if (Direction.directions[var24] == "EAST"){
					colorDirections = EnumChatFormatting.BLUE + "East" + EnumChatFormatting.RESET;
				}
				else if (Direction.directions[var24] == "SOUTH"){
					colorDirections = EnumChatFormatting.GREEN + "South" + EnumChatFormatting.RESET;
				}
                var8.drawStringWithShadow("[Direction: " + colorDirections + "]", var6 - 113, 50, 16777215);
			}
