...
public class GuiIngameMenu extends GuiScreen {
	...
	public void initGui() {
		...
		this.buttonList.add(b = new GuiButton(9, this.width / 2 - 100, this.height / 4 + 72 + var1, "Achievements..."));
	...
	public void drawScreen(int par1, int par2, float par3) {
		...
		drawString(fontRenderer, "kone Client: " + ConfigConstants.version, 6, 27, 0x999999);
